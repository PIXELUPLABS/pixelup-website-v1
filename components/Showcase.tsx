...
export function Showcase({ scroll = "internal" }: { scroll?: "internal" | "page" }) {
  return (
    // Vertical stack (not a grid). 40px gap on mobile, 32px on desktop.
    //
    ...
    // column looked like one undifferentiated stack of images and text. 40px
    ...
    <main
      ...
      className={`flex flex-col gap-10 desk:flex-1 desk:gap-8 ${
